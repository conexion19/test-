...
local Themes = {
	...
	Slate = {
		...
		InputIndicator = Color3.fromRGB(120, 210, 255),
		InputIndicatorFocus = Color3.fromRGB(150, 230, 255),
		Dialog = Color3.fromRGB(15, 5, 32),
		DialogHolder = Color3.fromRGB(18, 8, 38),
		DialogHolderLine = Color3.fromRGB(70, 28, 125),
		DialogButton = Color3.fromRGB(28, 12, 52),
		DialogButtonBorder = Color3.fromRGB(90, 35, 140),
		DialogBorder = Color3.fromRGB(80, 30, 130),
